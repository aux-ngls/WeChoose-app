...
async function clearRecommendationCaches(username: string) {
  ...
  const cacheKeys = keys.filter((key) => key.startsWith(`reliure:tinder-stack:${username}:`));
        ...
        <View style={styles.optionsList}>
          ...
          >
            ...
            <View style={styles.optionBody}>
              ...
              <Text style={[styles.optionDetail, { color: theme.colors.textMuted }]}>Ouvre la page d'aide publique de Reliure.</Text>
            </View>
