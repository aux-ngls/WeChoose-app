...
- kept the review details layout horizontal while widening the text column so the review content can use the full available width beside the poster.
...
- review detail pages now keep the original horizontal layout while widening the text column.
